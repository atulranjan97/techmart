...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="w-full overflow-hidden transition-shadow duration-300 bg-gray-100 border border-slate-300">
      {/* Product Image */}
      <Link to={`/products/${product._id}`}>
        <div className="aspect-5/4 flex items-center justify-center bg-white">
          <img
            src={product.image}
            alt={product.name}
