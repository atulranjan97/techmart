...
// we're gonna need to get the id from the url and we can get that with a hook called useParams and that's from react-router-dom
...
const ProductPage = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-7">
            ...
            <button className="mb-4 inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-black transition">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div>
                    ...
                    <div className="mt-6 text-gray-700 flex gap-x-3">
                        ...
                        <span className='font-bold text-gray-500'>{product.countInStock === 0 ? "Out of Stock": "In Stock"}</span>
                    </div>
                    ...
                    <div className="flex gap-4 mt-8">
                        ...
                        <button disabled={product.countInStock === 0} className={`px-6 py-3 border rounded-lg hover:bg-gray-100 ${product.countInStock === 0 && "opacity-50 cursor-not-allowed"}`}>
                        Buy Now
                        </button>
                    </div>
